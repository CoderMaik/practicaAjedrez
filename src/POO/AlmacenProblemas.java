...
//PROBLEMA 4
  ...
  //PROBLEMA 5
                ...
                Casilla casilla_51 = new Casilla('d', 8);
                p_51.setColor(Color.BLANCO);
                p_51.setTab(tablero_5);
                casilla_51.addPieza(p_51);
                tablero_5.getMapa()['d'][8] = casilla_51;

                Pieza p_52 = new Caballo();
                Casilla c_52 = new Casilla('e', 8);
                p_52.setCas(c_52);
                ...
                c_54.addPieza(p_54);
                tablero_5.getMapa()['a'][7] = c_54;

                Pieza p_55 = new Peon();
                Casilla c_55 = new Casilla('d', 7);
                p_55.setCas(c_55);
                p_55.setColor(Color.BLANCO);
                p_55.setTab(tablero_5);
                c_55.addPieza(p_55);
                tablero_5.getMapa()['d'][7] = c_55;

                Pieza p_56 = new Rey();
                Casilla c_56 = new Casilla('e', 7);
                p_56.setCas(c_56);
                p_56.setColor(Color.NEGRO);
                p_56.setTab(tablero_5);
                c_56.addPieza(p_56);
                tablero_5.getMapa()['e'][7] = c_56;

                Pieza p_57 = new Peon();
                Casilla c_57 = new Casilla('f', 7);
                p_57.setCas(c_57);
                p_57.setColor(Color.BLANCO);
                p_57.setTab(tablero_5);
                c_57.addPieza(p_57);
                tablero_5.getMapa()['f'][7] = c_57;

                Pieza p_58 = new Peon();
                Casilla c_58 = new Casilla('e', 6);
                p_58.setCas(c_58);
                p_58.setColor(Color.NEGRO);
                p_58.setTab(tablero_5);
                c_58.addPieza(p_58);
                tablero_5.getMapa()['e'][6] = c_58;

                Pieza p_59 = new Rey();
                Casilla c_59 = new Casilla('e', 3);
                p_59.setCas(c_59);
                p_59.setColor(Color.BLANCO);
                p_59.setTab(tablero_5);
                c_59.addPieza(p_59);
                tablero_5.getMapa()['e'][3] = c_59;

                Pieza p_510 = new Torre();
                Casilla c_510 = new Casilla('d', 1);
                p_510.setCas(c_510);
                p_510.setColor(Color.BLANCO);
                p_510.setTab(tablero_5);
                c_510.addPieza(p_510);
                tablero_5.getMapa()['d'][1] = c_510;
